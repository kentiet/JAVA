 ...
 *	Version 1 (Buggy)
 *
 *	This programs asks the user to enter a number "n",
 *	then prints out the first "n" numbers of the Fibonacci Sequence.
 *	Each number is the sum of the two previous numbers.
 *
 *  The output for n=11 should look exactly like this: 
 *  
